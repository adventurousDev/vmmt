...
var filename = "vmmt.exe";                     // The name of the executable to launch - change * to match the file name you want to launch at the end of your setup
...
try
{
        ...
        sql = "INSERT INTO `Control` (`Dialog_`, `Control`, `Type`, `X`, `Y`, `Width`, `Height`, `Attributes`, `Property`, `Text`, `Control_Next`, `Help`) VALUES ('FinishedForm', 'CheckboxLaunch', 'CheckBox', '9', '" + CheckBoxY + "', '343', '12', '3', 'LAUNCHAPP', '{\\VSI_MS_Sans_Serif13.0_0_0}" + checkboxText + "', 'Line1', '|')";
        view = database.OpenView(sql);
        view.Execute();
        view.Close();
        ...
        sql = "INSERT INTO `CustomAction` (`Action`, `Type`, `Source`, `Target`) VALUES ('VSDCA_Launch', '226', 'TARGETDIR', '[TARGETDIR]vmmt.exe')";
        view = database.OpenView(sql);
        view.Execute();
        view.Close();
